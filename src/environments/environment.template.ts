...
export const environment = {
  ...
  appSection: {
    ...
    MLT: {
      ...
      maxFreeTranslateCharsPerMonth:
        __appSection.MLT.MAX_FREE_TRANSLATE_CHARS_PER_MONTH__,
      maxFreeTranslateCharsPerMonthForUser:
        __appSection.MLT.MAX_FREE_TRANSLATE_CHARS_PER_MONTH_FOR_USER__,
      maxFreeTranslateCharsBufferPerMonth:
        __appSection.MLT.MAX_FREE_TRANSLATE_CHARS_BUFFER_PER_MONTH__,
      maxInputLength: __appSection.MLT.MAX_INPUT_LENGTH__,
    },
    IS: {
      maxFeatureCharsTotalPerMonth:
        __appSection.IS.MAX_FEATURE_CHARS_TOTAL_PER_MONTH__,
      maxFeatureCharsUserPerMonth:
        __appSection.IS.MAX_FEATURE_CHARS_USER_PER_MONTH__,
    },
  },
  firebase: {
