...
- **z-control Translator (English)**: `src/assets/privacy/policies/multi-language-translator/multi-language-translator-en.html`
- **z-control Translator (German)**: `src/assets/privacy/policies/multi-language-translator/multi-language-translator-de.html`
