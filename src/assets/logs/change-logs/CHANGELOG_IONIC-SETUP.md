...
- Added missing translations and renamed translation prefixs from "TRANSLATE" to "FEATURE" to ensure consistency and clarity in the app's internationalization, and update the unit tests to reflect the new translation keys, improving test coverage and reliability.
